...
const SongCard = ({ song, i, isPlaying, activeSong, data }) => {
  ...
  return (
    <div className="flex flex-col w-[183px] p-3 bg-transparent border-solid border-[1px] border-neutral-700 backdrop-blur-sm animate-slideup rounded-2xl cursor-pointer hover:bg-neutral-800">
